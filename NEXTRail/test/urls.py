...
from .views import PnrView, SeatAvailibility, TrainDetailView, TrainSeatsView, StationView, TicketsView, BookTickets, CancelTickets
...
urlpatterns = [
    ...
    path('cancel/', CancelTickets.as_view()),
